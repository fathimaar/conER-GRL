...
class IEMOCAP_pair_Dataset(Dataset):
    ...
    def __init__(self, path):
        ...
        self.states_f_visual, self.next_states_titles, self.next_states_f_text,
        self.next_states_f_audio, self.next_states_f_visual,\
        self.action, self.done = pair_env.states_titles, pair_env.pair_Labels,
        pair_env.states_f_text, pair_env.states_f_audio,\
        pair_env.states_f_visual, pair_env.next_states_titles, 
        pair_env.next_states_f_text, pair_env.next_states_f_audio, 
        pair_env.next_states_f_visual,\
